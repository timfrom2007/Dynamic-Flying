...
bool tkFC(Script *script, UserData data)
{
    ...
    //const Flight *flight = script->getFlight();
    const Flight *flight = new Flight(script->getApi());
...
bool dtFC(Script *script, UserData data)
{
     Flight const *flight = script->getFlight();
     cout << "q0 : " << flight->getQuaternion().q0 << endl;
     cout << "q1 : " << flight->getQuaternion().q1 << endl;
     cout << "q2 : " << flight->getQuaternion().q2 << endl;
     cout << "q3 : " << flight->getQuaternion().q3 << endl;
