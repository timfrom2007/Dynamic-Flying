...
function mousePressed() {
            ...
            randomFlightMove(currentX, currentY, turnCase, descision, move_distance);
...
function twoleaf_FlightMove(currX, currY, turnCases, descision, move_distance) {
    ...
    if (step_count < 20) {
        currentX += Math.round((move_distance / 20) * (20 - step_count));
        currentY += -Math.round((move_distance / 20) * (step_count));
    } else if (20 <= step_count && step_count < 40) {
        currentX += -Math.round((move_distance / 20) * (40 - step_count));
        currentY += Math.round((move_distance / 20) * (step_count - 20));
    } else if (40 <= step_count && step_count < 60) {
        currentX += -Math.round((move_distance / 20) * (60 - step_count));
        currentY += -Math.round((move_distance / 20) * (step_count - 40));
    } else if (60 <= step_count && step_count < 80) {
        currentX += Math.round((move_distance / 20) * (80 - step_count));
        currentY += Math.round((move_distance / 20) * (step_count - 60));
    }
    else{
        randomFlightMove(currX, currY, turnCases, descision, move_distance);
    }


}

function randomFlightMove(currX, currY, turnCases, descision, move_distance) {
